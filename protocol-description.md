...
### MASTER - устройство, обеспечивающее взаимодействие с приложением по Bluetooth и считывание данных с датчиков, а также фильтрацию и калибровку данных
### MODULE - устройство, обеспечивающее работу с реальным физическим датчиком (датчиками) и нормирование "сырых" данных к значениям физической величины в виде значения с плавающей точкой
***
## Характеристики системы <MASTER-MODULE>:
* количество физических датчиков в рамках одного MODULE - от 1 и выше;
* количество каналов в рамках одного датчика - от 1 и выше (например, акселерометер - трёхканальный);
