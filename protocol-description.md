...
|2 |[AT+TEST](#attest) |Test, Read        |Проверка готовности MODULE к работе              |
...
* в варианте Test (***AT+TEST=?***) MODULE должен вернуть ***OK***
    > **пример:**  
    > \-\> AT+TEST=?\r\n  
    > \<\- OK\r\n
* в варианте Read (***AT+TEST?***) MODULE должен вернуть состояние своей готовности
