...
<p align="center">
  <img src="/related-documents/pictures/updater-start-page.png">
</p>  
...
***
## Этап 4: тестирование
В случае успешного выполнения преддущего пункта, запустить программу CLIENT_APP. Выбрать в выпадающем списке нужный тип мультисенсора и подключиться к нему. После чего провести проверку работоспособности мультисенсора со всеми датчиками на всех диапазонах  
<p align="center">
  <img src="/related-documents/pictures/client-start-page.png">
</p>  
